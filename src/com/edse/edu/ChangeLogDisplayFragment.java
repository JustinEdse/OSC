...
public class ChangeLogDisplayFragment extends SherlockFragment
{
	...
	ArrayList<ChangeLog> disLogs = new ArrayList<ChangeLog>();
	public static ArrayList<ChangeLog> modifiedListLog = new ArrayList<ChangeLog>();
			...
			Bundle savedInstanceState)
	{
		...
		{
			disLogs = MainActivity.logsReturned;
		}

		View view = inflater
				.inflate(R.layout.article_display, container, false);
		...
		for (ChangeLog log : disLogs)
		{

			// type.add(art.getType());

				modifiedListLog.add(log);
		...
		displayListView.setAdapter(new ChangeLogAdapter(0, getActivity()
		...
		displayListView.setOnItemClickListener(new OnItemClickListener()
		{
					...
					int position, long id)
			{
				...
				String url = "";
					...
					url = modifiedListLog.get(position).getLink();
